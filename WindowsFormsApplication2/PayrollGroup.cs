...
namespace WindowsFormsApplication2
{
    public partial class PayrollGroup : Form
    {
        ...
        private void PayrollGroup_Load(object sender, EventArgs e)
        {
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            if (btnEdit.Text == "UPDATE")
            {
                ...
                cmd.CommandText = "sp_UpdatePayrollGroup";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 && btnClose.Text == "CLOSE")
            {
                ...
                txtCode.Text = row.Cells["Payroll_Code"].Value.ToString();
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            ...
            if (btnNew.Text == "SAVE")
            {
                ...
                else
                {
                    ...
                    cmd.Connection = con;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandText = "sp_InsertPayrollGroup";
                    cmd.Parameters.AddWithValue("@Payroll_Code", txtCode.Text);
                    txtDescription.Text = txtDescription.Text.Trim(); //trim space first
                    cmd.Parameters.AddWithValue("@Description", txtDescription.Text.ToUpper());
                    cmd.Parameters.AddWithValue("@Remarks", txtRemarks.Text);
            ...
            else
            {
                ...
                SqlCommand cmd = new SqlCommand("sp_AutoGeneratePayrollGroupCode", con);
                cmd.CommandType = CommandType.StoredProcedure;
