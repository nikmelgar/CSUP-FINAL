...
{
    public partial class QueryLoanListing : UserControl
    {
        public QueryLoanListing()
        {
            InitializeComponent();
        }

        Classes.clsQuery clsQuery = new Classes.clsQuery();
        private void QueryLoanListing_Load(object sender, EventArgs e)
        {
        ...
        public void loadLoanListing()
        {
            clsQuery.loadLoanListing(Classes.clsQuery.searchUserID, dataGridView1);
        }
