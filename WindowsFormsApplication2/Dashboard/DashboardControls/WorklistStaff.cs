...
{
    public partial class WorklistStaff : UserControl
    {
        public WorklistStaff()
        {
            InitializeComponent();
        }
        ...
        DashboardClasses.clsWorklistsStaff clsStaff = new DashboardClasses.clsWorklistsStaff();

        Global global = new Global();

        private void WorklistStaff_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                clsStaff.loadJournalVoucher(lblCnt, dgvList);
            }
            else
            {
                clsStaff.loadJournalVoucherAudit(lblCnt, dgvList);
            }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if(Classes.clsUser.department.ToString() == "1")
            {
                clsStaff.loadDisbursementVoucher(lblCnt, dgvList);
            }
            else
            {
                clsStaff.loadDisbursementVoucherAudit(lblCnt, dgvList);
            }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if(Classes.clsUser.department.ToString() == "1")
            {
                //clsStaff.loadReceiptVoucher(lblCnt, dgvList);
            }
            else
            {
                clsStaff.loadReceiptVoucherAudit(lblCnt, dgvList);
            }
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if(Classes.clsUser.department.ToString() == "1")
            {
                clsStaff.loadAllVoucher(lblCnt, dgvList);
            }
            else
            {
                clsStaff.loadAllVoucherAudit(lblCnt, dgvList);
            }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                switch (dgvList.SelectedRows[0].Cells[1].Value.ToString())
                {
                    case "JV":
                        //Check if open
