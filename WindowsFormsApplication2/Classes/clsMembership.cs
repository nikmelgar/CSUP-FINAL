    ...
    class clsMembership
    {
        ...
        public string countActiveMembers(Label lblActive)
        {
            ...
            using (SqlConnection con = new SqlConnection(global.connectString()))
            {
                ...
                SqlDataAdapter adapter = new SqlDataAdapter("SELECT count(*) FROM Membership WHERE IsApprove ='1' and IsActive = '1' and Company_Code = 'COMP010' and Date_Resigned_From_Pecci is NULL", con);
                DataTable dt = new DataTable();
                adapter.Fill(dt);
        ...
        public string countTotalMembers(Label lblTotalMember)
        {
            ...
            using (SqlConnection con = new SqlConnection(global.connectString()))
            {
                ...
                SqlDataAdapter adapter = new SqlDataAdapter("SELECT count(*) FROM Membership WHERE IsApprove ='1' and IsActive = '1' and Date_Resigned_From_Pecci is NULL", con);
                DataTable dt = new DataTable();
                adapter.Fill(dt);
