    ...
    class clsLoanATM
    {
        ...
        public void loadATMWithdrawal(DataGridView dgv)
        {
            using (SqlConnection con = new SqlConnection(global.connectString()))
            {
                ...
                adapter = new SqlDataAdapter("SELECT * FROM vw_LoanToATM order by Bank_Code", con);
                dt = new DataTable();
                adapter.Fill(dt);
        ...
        public void loadBank(ComboBox cmb)
        {
            ...
            using (SqlConnection con = new SqlConnection(global.connectString()))
            {
                ...
                adapter = new SqlDataAdapter("SELECT DISTINCT(Bank_Code) FROM vw_LoanToATM Order By Bank_Code", con);
