...
namespace WindowsFormsApplication2
{
    public partial class TransactionType : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            string msg = Environment.NewLine + "Are you sure you want to delete this Transaction Type?";
            ...
            if (result == DialogResult.Yes)
            {
                ...
                //Message
                Alert.show("Transaction Type Successfully Deleted", Alert.AlertType.success);
            }
            else
            {
                return;
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 && btnClose.Text == "CLOSE")
            {
                ...
                txtCode.Text = row.Cells["Transaction_Code"].Value.ToString();
